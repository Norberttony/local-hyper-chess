...
export class PGNWidget extends BoardWidget {
    ...
    constructor(boardgfx, location) {
        ...
        const back = pgnControl.getElementsByClassName("pgn-viewer__back")[0];
        addPointerHoldListener(back, () => {
            this.PGNMoveBack();
        });
        const next = pgnControl.getElementsByClassName("pgn-viewer__next")[0];
        addPointerHoldListener(next, () => {
            this.PGNMoveForward();
        });
        const first = pgnControl.getElementsByClassName("pgn-viewer__first")[0];
        first.addEventListener("click", () => {
            // displays position with no moves made on the board
            this.PGNMoveFirst();
        });
        const last = pgnControl.getElementsByClassName("pgn-viewer__last")[0];
...
//# sourceMappingURL=pgn-widget.js.map